...
set "DESTINATION_FOLDER=%~dp0..\App\ComfyUI\custom_nodes\ComfyUI-Inspire-Pack\prompts"
...
REM Delete the Sync prompts.bat file from the destination folder if it exists
    ...
    del "%DESTINATION_FOLDER%\0-COPY prompts to ComfyUI.bat"
	del "%DESTINATION_FOLDER%\0-OPEN ComfyUI prompts folder.bat"


echo Prompt sync completed...
pause
